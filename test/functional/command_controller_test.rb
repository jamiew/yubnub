...
class CommandControllerTest < ActionController::TestCase
  ...
  def test_banning_empty_string
    ...
    assert_equal(1, Command.all("url LIKE 'http://aaaaa.com'").size)
  end
  def test_ignore_spam_bots_1
    assert_equal(0, Command.all("url LIKE 'http://aaaaa.com'").size)
    post :add_command, {'x' => '', 'command' => {'name' => 'aaaaa', 'url' => 'http://aaaaa.com', 'description' => 'A great site!'}}
    assert_redirected_to :action => 'index'
    assert_equal(1, Command.all("url LIKE 'http://aaaaa.com'").size)
  end
  ...
  def test_banning_percent_signs
    assert_equal(0, BannedUrlPattern.all("pattern = 'http://'").size)
    ...
    assert_equal(1, BannedUrlPattern.all("pattern = 'http://'").size)
    assert_equal(0, Command.all("url LIKE 'http://aaaaa.com'").size)
    post :add_command, {'x' => '', 'command' => {'name' => 'aaaaa', 'url' => 'http://aaaaa.com', 'description' => 'A great site!'}}
    assert_equal(1, Command.all("url LIKE 'http://aaaaa.com'").size)
  end
  ...
  def test_banning_1
    assert_equal(0, Command.all("url LIKE 'http://welovespam.com%'").size)
    assert_equal(0, BannedUrlPattern.all("pattern LIKE '%welovespam%'").size)

    post :add_command, {'x' => '', 'command' => {'name' => 'spam1', 'url' => 'http://welovespam.com', 'description' => 'A great site!'}}
    assert_redirected_to :action => 'index'
    assert_equal(1, Command.all("url LIKE 'http://welovespam.com%'").size)
    assert_equal(0, BannedUrlPattern.all("pattern LIKE '%welovespam%'").size)

    post :add_command, {'x' => '', 'command' => {'name' => 'spam2', 'url' => 'http://welovespam.com', 'description' => 'A great site!'}}
    assert_redirected_to :action => 'index'
    assert_equal(2, Command.all("url LIKE 'http://welovespam.com%'").size)
    assert_equal(0, BannedUrlPattern.all("pattern LIKE '%welovespam%'").size)

    post :add_command, {'x' => '', 'command' => {'name' => 'spam3', 'url' => 'http://welovespam.com', 'description' => 'A great site!'}}
    assert_redirected_to :action => 'index'
    assert_equal(3, Command.all("url LIKE 'http://welovespam.com%'").size)
    assert_equal(0, BannedUrlPattern.all("pattern LIKE '%welovespam%'").size)

    post :add_command, {'x' => '', 'command' => {'name' => 'spam4', 'url' => 'http://welovespam.com', 'description' => 'A great site!'}}
    assert_redirected_to :action => 'index'
    assert_equal(0, Command.all("url LIKE 'http://welovespam.com%'").size)
    assert_equal(1, BannedUrlPattern.all("pattern LIKE '%welovespam%'").size)
    assert_equal('http://welovespam.com', BannedUrlPattern.find(:first, :conditions => "pattern LIKE '%welovespam%'").pattern)
    ...
    pattern.save
    assert_equal(2, BannedUrlPattern.all("pattern LIKE '%welovespam%'").size)
    ...
    assert_not_nil Command.find(:first, :conditions => "name='gim'")
  end
  def test_banning_2
    command = Command.new
    ...
    post :add_command, {'x' => '', 'command' => {'name' => 'spam3', 'url' => 'http://welovespam.com', 'description' => 'A great site!'}}
    assert_redirected_to :action => 'index'
    assert_equal(4, Command.all("url LIKE 'http://welovespam.com%'").size)
    assert_equal(0, BannedUrlPattern.all("pattern LIKE '%welovespam%'").size)

    post :add_command, {'x' => '', 'command' => {'name' => 'spam4', 'url' => 'http://welovespam.com', 'description' => 'A great site!'}}
    assert_redirected_to :action => 'index'
    assert_equal(5, Command.all("url LIKE 'http://welovespam.com%'").size)
    assert_equal(0, BannedUrlPattern.all("pattern LIKE '%welovespam%'").size)

    post :add_command, {'x' => '', 'command' => {'name' => 'spam5', 'url' => 'http://welovespam.com', 'description' => 'A great site!'}}
    assert_redirected_to :action => 'index'
    assert_equal(6, Command.all("url LIKE 'http://welovespam.com%'").size)
    assert_equal(0, BannedUrlPattern.all("pattern LIKE '%welovespam%'").size)

    post :add_command, {'x' => '', 'command' => {'name' => 'spam6', 'url' => 'http://welovespam.com?x', 'description' => 'A great site!'}}
    assert_redirected_to :action => 'index'
    assert_equal(7, Command.all("url LIKE 'http://welovespam.com%'").size)
    assert_equal(0, BannedUrlPattern.all("pattern LIKE '%welovespam%'").size)
  ...
  def test_spam_filter
    ...
    assert_nil(Command.find(:first, :conditions => "name='blah'"))
    post :add_command, {'x' => '', 'command' => {'name' => 'blah', 'url' => 'http://sonicate.com', 'description' => 'A great site!'}}
    assert_redirected_to :action => 'index'
    blah = Command.find :first, :conditions => "name='blah'"
    assert_nil blah
